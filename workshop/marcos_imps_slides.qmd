...
round(inspect(fit, what = "est")$theta, 2)      # Error covariances
...
round(latInspect(fit, what = "est")$theta, 2) # Error covariances
det(latInspect(fit, what = "est")$theta)      # Check the determinant
```
