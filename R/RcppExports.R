...
asymptotic_poly <- function(X, R, cores) {
    .Call(`_latent_asymptotic_poly`, X, R, cores)
}

diagConc <- function(X1, X2) {
    .Call(`_latent_diagConc`, X1, X2)
}

smoothing <- function(X, min_eigval = 0.001) {
    .Call(`_latent_smoothing`, X, min_eigval)
}

consecutive <- function(lower, upper) {
    .Call(`_latent_consecutive`, lower, upper)
}

orthogonalize <- function(X, x) {
    .Call(`_latent_orthogonalize`, X, x)
}

cfa_test <- function(R, lambda, phi, psi, dlambda, dphi, dpsi, W, estimator, projection) {
    .Call(`_latent_cfa_test`, R, lambda, phi, psi, dlambda, dphi, dpsi, W, estimator, projection)
}
