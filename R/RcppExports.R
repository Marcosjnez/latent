...
asymptotic_poly <- function(data, correlation, thresholds, return_scores = FALSE, probability_floor = 1e-12, inversion_tolerance = 1e-10, polyfast_object = NULL, cores = 1L) {
    .Call(`_latent_asymptotic_poly`, data, correlation, thresholds, return_scores, probability_floor, inversion_tolerance, polyfast_object, cores)
}
