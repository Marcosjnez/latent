...
- [`information(`*`<latent>`*`)`](https://marcosjnez.github.io/latent/reference/information.latent.md)
  : Hessian and Variance-Covariance Matrix matrix for Latent Models
  using the Information method
- [`information(`*`<lcfa>`*`)`](https://marcosjnez.github.io/latent/reference/information.lcfa.md)
  : Hessian and Variance-Covariance Matrix matrix for Confirmatory
  Factor Models using the Information method
...
- [`plot(`*`<llcalist>`*`)`](https://marcosjnez.github.io/latent/reference/plot.llcalist.md)
...
- [`print(`*`<llca_plots>`*`)`](https://marcosjnez.github.io/latent/reference/print.llca_plots.md)
